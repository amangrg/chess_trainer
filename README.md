...
python evaluate.py --dataset data/lichess_db_eval.jsonl.zst --model deepseek-ai/DeepSeek-Coder-V2-Lite-Instruct --mode train --train_samples 5000 --val_samples 500 --test_samples 0 --epochs 1 --batch_size 4 --learning_rate 2e-5 --output_dir ./ft_model